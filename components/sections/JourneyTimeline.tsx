...
export function JourneyTimeline() {
  ...
  return (
    <div className="relative w-full bg-black py-12 md:py-20 lg:py-24 pb-20 md:pb-32 lg:pb-40">
      ...
      <div className="px-4 md:px-8 lg:px-16 overflow-x-hidden md:overflow-visible">
