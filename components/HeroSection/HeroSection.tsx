...
export function Hero() {
    ...
    return (
        ...
        >
            ...
            {/* Content */}
            <div className="relative z-[2] flex h-full flex-col items-center justify-end pb-12 md:pb-20 text-center">
                <h1
                    ref={textRef}
                    className="text-3xl md:text-5xl lg:text-7xl font-bold leading-tight md:leading-none tracking-tighter max-w-[90vw] px-4 text-[#ffdd58]"
                >
                    MarkTaleWorld - <br /> 
                ...
                <p className="mt-6 md:mt-8 text-lg md:text-2xl font-medium max-w-2xl px-4 text-white">
